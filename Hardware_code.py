...
# Final: robust color handling (BGRA/RGB), in-memory API upload, fixed spoof logic,
# helmet majority voting, confidences shown in overlay and LCD.
...
helmet_model = YOLO('/home/pi/Downloads/helmv4.2.pt')
